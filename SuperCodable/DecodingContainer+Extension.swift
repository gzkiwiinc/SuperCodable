...
public extension SingleValueDecodingContainer {
    func decode<Transformer: DecodingContainerTransformer>(transformer: Transformer) throws -> Transformer.TargetType where Transformer.DecodeType: Decodable {
...
public extension KeyedEncodingContainer {
    ...
    mutating func encode<Transformer: EncodingContainerTransformer>(_ value: Transformer.TargetType,
